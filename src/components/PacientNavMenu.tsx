    ...
    return (
        <NavigationMenu className="lg:px-30 px-4 gap-4 my-2 flex-none">
            <NavigationMenuList className="flex flex-row flex-wrap bg-white border border-gray-300 px-4 rounded-lg">
                ...
                <NavigationMenuItem>
                    <NavigationMenuLink className="hover:bg-gray-200 focus:bg-gray-200" asChild><a href="/notes" className="text-black font-semibold"><FileText />Anotações</a></NavigationMenuLink>
                </NavigationMenuItem>
                <NavigationMenuItem>
                    <NavigationMenuLink className="hover:bg-gray-200 focus:bg-gray-200" asChild><a href="/documents" className="text-black font-semibold"><FileUp />Documentos</a></NavigationMenuLink>
                </NavigationMenuItem>
                <NavigationMenuItem>
